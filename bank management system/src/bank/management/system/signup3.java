...
JLabel detaill = new JLabel("Your 4 Digit Password");
detaill.setFont(new Font("Railway", Font.BOLD, 12));
detaill.setBounds(100, 400, 300, 20);
add(detaill);
  ...
  getContentPane().setBackground(Color.WHITE);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if (ae.getSource()==submit)
        {
           ...
           String carddnumber= ""+ Math.abs((random.nextLong() % 90000000L))+ 5040936000000000L;
           
           String pinnnumber= ""+ Math.abs((random.nextLong() % 9000L )+1000L);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == submit) {
            ...
            try {
                ...
                "VALUES('" + formno + "','" + accountType + "','" + carddnumber + "','" + pinnnumber + "','" + facility + "')";

String query2 = "INSERT INTO login (formno, card_number, pin) " +
                "VALUES('" + formno + "','" + carddnumber + "','" + pinnnumber + "')";
...
conn.s.executeUpdate(query2);
                    ...
                    JOptionPane.showMessageDialog(null, "Card Number: " + carddnumber + "\nPIN: " + pinnnumber);
                    setVisible(false);
                    new depositt(pinnnumber).setVisible(false); 
                }
            } catch (Exception e) {
                System.out.println(e);
            }
            ...
            setVisible(false);
            new login().setVisible(true); // go back to login or previous screen
        }
    }
